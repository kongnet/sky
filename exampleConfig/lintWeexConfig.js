const config = {
  ...
  packages: {
    scripts: {
      ...
      'lint:fix':
        "eslint --fix --ext .js,.vue src && stylelint 'src/**/*.css' --fix && stylelint src/**/*.{html,vue} --custom-syntax postcss-html --fix",
      'lint:style':
        "stylelint 'src/**/*.css' && stylelint src/**/*.{html,vue} --custom-syntax postcss-html",
